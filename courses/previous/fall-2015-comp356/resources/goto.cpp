...
// This is an example of some code that might reasonably use a goto
// statement (although there are other reasonable ways of writing this
// code without using gotos).
