/**
 * The LinkedList132Unfinished class is an implementation of the ListADT interface
 ...
 *
 */
public class LinkedList132Unfinished implements ListADT {

	private LinkedNode head;
	private int listSize;

	public LinkedList132Unfinished() {
		head = null;
		listSize = 0;
	}
	...
	public static void main(String[] args) {
		LinkedList132Unfinished list = new LinkedList132Unfinished();
		...
		// The following will give correct results when homework is
		// complete.
		...
		System.out.println(list);
		System.out
				.println("After jumping successor of node 1 ahead by 2:");
